...
{
    /// <summary>
    /// Defines a generalized type-specific coalescense method for reducing two its instances into a single one.
    /// </summary>
    public interface ICoalescible
    {
        /// <summary>
