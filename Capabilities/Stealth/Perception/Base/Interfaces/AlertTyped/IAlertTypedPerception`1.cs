...
namespace StealthSystemPrototype.Perceptions
{
    ...
    public interface IAlertTypedPerception<A, P> : IAlertTypedPerception
        where A : class, IAlert, new()
        where P : class, IPurview<A>
    {
        public new P Purview { get; set; }
        ...
        public void WritePurview(SerializationWriter Writer, P Purview);
        ...
        public void ReadPurview(
            ...
            ref P Purview,
            IAlertTypedPerception<A, P> ParentPerception = null);
