...
namespace StealthSystem
{
    ...
    static class Flag
    {
        public const string STEALTH = "StealthModStringProperty";
    }
    /// <summary>
    ...
    class StealthCore
    {
        ...
        public StealthCore(XRL.World.Parts.Stealth Source) => this.Source = Source;
        public StealthCore(XRL.World.Parts.Stealth Source, LightLevel? LightLevel, bool ConsiderPlantsWitnesses = false, List<GameObject> Exclusions = null, List<GameObject> Additions = null, bool ForceStealth = false)
        {
            this.Source = Source;
